...
class Organization extends Fieldset {
	constructor() {
		let fields = ["pin_code_prefix", "resource_source", "provides", "has_schedule", "has_unit", "unit_of", "org_timezone", "booking_methods", "live_autopostpone", "live_autorestore", "live_autopostpone_count",
