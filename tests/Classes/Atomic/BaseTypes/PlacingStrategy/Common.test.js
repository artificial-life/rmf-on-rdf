...
var State = require(_base + '/build/Classes/Atomic/BaseTypes/Primitive/State/State.js');
var TimeChunk = require(_base + '/build/Classes/Atomic/BaseTypes/Primitive/TimeChunk.js');
...
describe('Common Strategy', function() {
  ...
  beforeEach(() => {
    newbee = new TimeChunk([
      [50, 70]
    ]);
    oldone = new TimeChunk([
      [0, 100]
    ]);
  });
